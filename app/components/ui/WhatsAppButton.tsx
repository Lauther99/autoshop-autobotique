  ...
  if (inline) {
    return (
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded border border-[#25D366] bg-[#25D366]/10 px-3 py-2.5 text-xs font-semibold uppercase text-[#25D366] transition hover:bg-[#25D366] hover:text-white"
      >
